...
export const grishma =createContext()
const Api = (props) => {
    const [data,setData]=useState([
        {
            ...
            "ImageAsset" : "https://c.ndtvimg.com/2022-01/qtklueco_katrina-kaif-_625x300_13_January_22.jpg","BlogContent" : "The film will also star Priyanka Chopra and Alia Bhatt in the lead roles along with Katrina Kaif",
            "Likes" : "1000K"
        },
        {
    ...
    return (
    <div>
     <grishma.Provider value={[data,setData]}>
       {props.children}
     </grishma.Provider>
